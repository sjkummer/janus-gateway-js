...
VideocallPlugin.prototype.handleCreatePeerConnection = function(options) {
  ...
  return self.handleGetUserMedia2({audio:true, video:true})
  .then(function(stream){
...
VideocallPlugin.prototype.handleGetUserMedia2 = function ({audio = false, video = true}) {
  var self = this;
...
VideocallPlugin.prototype.handleGetUserMedia1 = function ({audio = false, video = true}) {
  var self = this;
  console.log('this', this)
  return new Promise((resolve, reject) => {
    console.log("before getUserMedia");
...
VideocallPlugin.prototype.handleCreateOffer = function(stream){
  var self = this;
  return Promise.try(() => {
    console.log("before createOffer");
    return self.createOffer();
...
VideocallPlugin.prototype.handleOfferStream = function({stream, offerOptions = {}, configureOptions = {}}){
  var self = this;
